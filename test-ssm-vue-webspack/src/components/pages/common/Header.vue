        ...
        <div class="user-info">
            <el-dropdown trigger="click" @command="handleCommand">
                ...
                <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item command="userInfo">上传图片</el-dropdown-item>
...
<script>
    export default {
        data() {
            return {
                name: '',
                imgUrl:'http://localhost:8082/img/'+sessionStorage.getItem("user_img")
            }
        },  
        computed:{
            username(){
            ...
            headerStataus() {
                return 'hello'//this.$store.getters.getHeaderStatus
            }
        },
        methods:{
